# Task Checklist: media_stack_all
Repository: https://skype.visualstudio.com/SCC/_git/media_stack_all
...
- {repo_url} → https://skype.visualstudio.com/SCC/_git/media_stack_all
- {repo_name} → media_stack_all
- {solutions_json} →
- {solutions} →
- {clone_path} →
- {repo_directory} →
